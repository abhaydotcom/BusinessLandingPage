...
const Newsletter = () => {
  return (
    <section
    id='newsletter'
    className="section-container px-4 md:px-0">
        <motion.div
        ...
        className="bg-purple-600 rounded-2xl overflow-hidden">
                <div className="relative md:px-16 px-6 py-16 md:py-24">
                    ...
                    <motion.div  variants={fadeIn('left', 0.4)} className="absolute top-0 right-0 w-1/2 h-full bg-purple-700 clip-path-slant hidden md:block">
                    </motion.div>
                        ...
                        <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12">
                            <motion.div   variants={fadeIn('right', 0.5)} className="text-white max-w-lg text-center md:text-left">
                                <motion.h2 variants={textVariant(0.3)} className="text-2xl sm:text-3xl md:text-4xl font-medium mb-4"> Subscribe newsletter</motion.h2>
                                <motion.p variants={fadeIn('up', 0.6)} className="text-purple-100 text-sm sm:text-base" > Best cooks and best delivery guys all at your service. Hot tasty food</motion.p>
                            </motion.div>
                  ...
                  whileTap={{ scale: 0.95 }}
                                    ...
                                    > Discover <HiArrowRight className="w-5 h-5" /></motion.button>
                                </motion.div>
                            </motion.div>
                        </div>
